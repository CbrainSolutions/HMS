<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmDailyNursingManagement.aspx.cs" Inherits="MainProjectHos.frmDailyNursingManagement" %>
                                                    ...
                                                    <asp:Panel ID="pnl" runat="server" Width="1020px" Style="border-color: Green; border-style: solid;
                                                        ...
                                                        <asp:GridView ID="dgvClaim" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="TreatmentDate" HeaderText="Treatment Date" ReadOnly="True"
                                                                    SortExpression="TreatmentDate" DataFormatString="{0:MM/dd/yyyy}" />
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 25%;" align="left">
                                                                    <asp:DropDownList ID="ddlNurseName" runat="server" Width="200px" AutoPostBack="true"
                                                                        OnSelectedIndexChanged="ddlNurseName_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center" colspan="2">
                                                                    <asp:RegularExpressionValidator ID="revTxtFirstName" ValidationExpression="^([0]\d|[1][0-2])\/([0-2]\d|[3][0-1])\/([2][01]|[1][6-9])\d{2}(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$"
                                                                        ...
                                                                        Font-Size="11px" ForeColor="Red" ControlToValidate="txtTreatmentDate" runat="server"
