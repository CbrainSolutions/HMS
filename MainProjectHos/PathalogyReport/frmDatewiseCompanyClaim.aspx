<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmDatewiseCompanyClaim.aspx.cs" Inherits="MainProjectHos.PathalogyReport.frmDatewiseCompanyClaim" %>
                    ...
                    <asp:Panel ID="Panel2" ScrollBars="Both" runat="server" Width="100%" Style="text-align: center;
                        ...
                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TDSAmt" HeaderText=" TDS Amount" ReadOnly="True"
                                    SortExpression="TDSAmt" DataFormatString="{0:0.00}" />
