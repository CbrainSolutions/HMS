<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmTDSReport.aspx.cs" Inherits="MainProjectHos.PathalogyReport.frmTDSReport" %>
                ...
                <asp:Panel ID="pnlContents" runat="server" Width="100%" align="center">
                    ...
                    <asp:Panel ID="Panel2" ScrollBars="Both" runat="server" Width="100%" Style="text-align: center;
                        ...
                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                            ...
                            <Columns>
                                <%--<asp:BoundField DataField="ClaimId" HeaderText="Claim Id" ReadOnly="True" SortExpression="ClaimId" />
                                ...
                                <asp:BoundField DataField="ApprovedDate" HeaderText="Approved Date" ReadOnly="True"
                                    SortExpression="ApprovedDate" DataFormatString="{0:MM/dd/yyyy}" />
                                ...
                                <asp:BoundField DataField="Discount" HeaderText="Discount" ReadOnly="True" SortExpression="Discount"
                                    DataFormatString="{0:0.00}" />
                                <asp:BoundField DataField="TDS" HeaderText="TDS" ReadOnly="True" SortExpression="TDS"
                                    DataFormatString="{0:0.00}" />
