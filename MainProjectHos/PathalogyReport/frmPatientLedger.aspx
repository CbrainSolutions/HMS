<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmPatientLedger.aspx.cs" Inherits="MainProjectHos.PathalogyReport.frmPatientLedger" %>
                ...
                <asp:Panel ID="pnlContents" runat="server" Width="100%" align="center">
                    ...
                    <asp:Panel ID="Panel2" ScrollBars="Both" runat="server" Width="80%" Style="text-align: center;
                        ...
                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                            ...
                            <Columns>
                                <asp:BoundField DataField="TransactionDocNo" HeaderText="Bill No." ReadOnly="True"
                                    SortExpression="TransactionDocNo" />
                                ...
                                <asp:BoundField DataField="AdvanceAmount" HeaderText="Advance Amount" ReadOnly="True" SortExpression="AdvanceAmount" />
                                <asp:BoundField DataField="PayAmount" HeaderText="Receipt" ReadOnly="True" SortExpression="PayAmount" />
