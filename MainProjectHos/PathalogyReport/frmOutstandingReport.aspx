<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmOutstandingReport.aspx.cs" Inherits="MainProjectHos.PathalogyReport.frmOutstandingReport" %>
            ...
            <div>
                ...
                <asp:Panel ID="pnlContents" runat="server" Width="100%" align="center">
                    ...
                    <asp:Panel ID="Panel2" ScrollBars="Both" runat="server" Width="80%" Style="text-align: center;
                        background-color: #E0F0E8; height: 100%;" BorderColor="Green" BorderStyle="Solid"
                        BorderWidth="1px">
                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Received" HeaderText="Received Amount" ReadOnly="True"
