<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmDischargePatientListReport.aspx.cs" Inherits="MainProjectHos.PathalogyReport.frmDischargePatientListReport" %>
                    ...
                    <asp:Panel ID="Panel2" ScrollBars="Both" runat="server" Width="1040px" Style="text-align: center;
                        ...
                        <asp:GridView ID="dgvTestParameter" runat="server" CellPadding="4" ForeColor="#333333"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DischargeDate" HeaderText="Discharge Date" ReadOnly="True" SortExpression="DischargeDate" />
