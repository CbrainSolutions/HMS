<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmTabletMaster.aspx.cs" Inherits="MainProjectHos.frmTabletMaster" %>
    ...
    <div style="width: 99%">
        ...
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="O.T. Prescription Master" Font-Names="Verdana"
                            ...
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl"  runat="server" Width="100%">
                                    ...
                                    <asp:GridView ID="dgvReligion" runat="server" CellPadding="4" ForeColor="#333333"
                                        BorderColor="Green" BorderStyle="Solid" BorderWidth="1px" DataKeyNames="TabletCode"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Tablet No" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkReligionCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditReligion" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("TabletCode") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="O.T. Prescription Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblReligionCode" runat="server" Text="Tablet No :" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblReligionName" runat="server" Text="Medicine Name :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Prescription Tablet Master" Font-Names="Verdana"
                                                    Font-Size="15px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="Tablet No :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="Medicine Name :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
