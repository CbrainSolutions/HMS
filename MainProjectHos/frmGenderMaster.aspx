<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmGenderMaster.aspx.cs" Inherits="MainProjectHos.frmGenderMaster" %>
    ...
    <div style="width: 99%">
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="Gender Master" Font-Names="Verdana" Font-Size="16px"
                            Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="width: 15%;">
                        <asp:Button ID="BtnAddNewGender" runat="server" Text="Add New" Font-Names="Verdana"
                            Font-Size="13px" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
                            onmouseover="SetBtnMouseOver(this)" onmouseout="SetBtnMouseOut(this)" OnClick="BtnAddNewGender_Click" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
                        ...
                        <tr>
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl"  runat="server" Width="100%">
                                    ...
                                    <asp:GridView ID="dgvGender" runat="server" CellPadding="4" ForeColor="#333333" DataKeyNames="GenderCode"
                                        GridLines="Both" Font-Names="Verdana" Width="100%" BorderColor="Green" BorderStyle="Solid"
                                        BorderWidth="1px" Font-Size="Small" AllowPaging="true" PageSize="20" AutoGenerateColumns="false"
                                        OnRowCommand="dgvGender_RowCommand" OnDataBound="dgvGender_DataBound" OnPageIndexChanged="dgvGender_PageIndexChanged"
                                        OnPageIndexChanging="dgvGender_PageIndexChanging" OnRowDataBound="dgvGender_RowDataBound">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Gender Code" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkGenderCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditGender" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("GenderCode") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="GenderDesc" HeaderText="Gender Desc" ReadOnly="True" SortExpression="GenderDesc" />
                                        </Columns>
                                    </asp:GridView>
                                </asp:Panel>
                            </td>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="Gender Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblGenderCode" runat="server" Text="Gender Code :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtGenderCode" runat="server" MaxLength="50" ReadOnly="true" Font-Names="Verdana"
                                                    Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblGenderName" runat="server" Text="Gender Description :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtGenderDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvGenderDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtGenderDesc" Font-Size="13"
                            ...
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Gender Master" Font-Names="Verdana" Font-Size="15px"
                                                    Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="Gender Code :" Font-Names="Verdana" Font-Size="11px"
                                                    ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditGenderCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="Gender Type :" Font-Names="Verdana" Font-Size="11px"
                                                    ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditGenderDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditGenderDesc" Font-Size="13"
