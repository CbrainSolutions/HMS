<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmAllocConsultDoctorToPatient.aspx.cs" Inherits="MainProjectHos.frmAllocConsultDoctorToPatient" %>
                                                        ...
                                                        <asp:GridView ID="dgvClaim" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="Consult_Date" HeaderText="Treatment Date" ReadOnly="True"
                                                                    SortExpression="Consult_Date" DataFormatString="{0:MM/dd/yyyy}" />
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 50%;" align="left">
                                                                    ...
                                                                    <asp:Calendar ID="CalDate" runat="server" TargetControlID="txtConsultDate"
                                                                        Format="MM/dd/yyyy">
                                                                    </asp:Calendar>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:RegularExpressionValidator ID="revTxtFirstName" ValidationExpression="^([0]\d|[1][0-2])\/([0-2]\d|[3][0-1])\/([2][01]|[1][6-9])\d{2}(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$"
                                                                        ...
                                                                        Font-Size="11px" ForeColor="Red" ControlToValidate="txtConsultDate" runat="server"
