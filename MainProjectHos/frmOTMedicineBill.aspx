<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmOTMedicineBill.aspx.cs" Inherits="MainProjectHos.frmOTMedicineBill" %>
                                                    ...
                                                    <asp:Panel ID="pnl" runat="server" Width="1020px" Style="border-color: Green; border-style: solid;
                                                        ...
                                                        <asp:GridView ID="dgvClaim" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="Bill_Date" HeaderText="Bill Date" ReadOnly="True"
                                                                    SortExpression="Bill_Date" DataFormatString="{0:MM/dd/yyyy}" />
