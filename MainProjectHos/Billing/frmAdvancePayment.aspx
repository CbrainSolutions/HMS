<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmAdvancePayment.aspx.cs" Inherits="MainProjectHos.Billing.frmAdvancePayment" %>
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="View1" runat="server">
                        <table width="100%">
                            <tr>
                                <td align="center">
                                    <asp:Label ID="lblCUstomer" runat="server" Text="Refund Payment Voucher" Font-Names="Verdana"
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td colspan="4" align="center">
                                                    <asp:Label ID="lblNote" Text="NOTE :- Please Return Full Amount" runat="server" ForeColor="Red"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <asp:TextBox ID="txtTransactDate" runat="server" Font-Names="Verdana" Font-Size="11px"
                                                        Width="140px" MaxLength="10" Format="MM/dd/yyyy hh:mm:ss tt"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red"
                                                        ControlToValidate="txtTransactDate" Font-Size="13" ValidationGroup="Save" ErrorMessage="*"
                                                        Display="Dynamic"></asp:RequiredFieldValidator>
                                                    <asp:Calendar ID="CalDOBDate" runat="server" TargetControlID="txtTransactDate"
                                                        Format="MM/dd/yyyy" DaysModeTitleFormat="MM/dd/yyyy" TodaysDateFormat="MM/dd/yyyy hh:mm:ss tt">
                                                    </asp:Calendar>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" colspan="2">
                                                    <asp:RegularExpressionValidator ID="revTxtFirstName" ValidationExpression="^([0]\d|[1][0-2])\/([0-2]\d|[3][0-1])\/([2][01]|[1][6-9])\d{2}(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$"
                                                        ...
                                                        Font-Size="11px" ForeColor="Red" ControlToValidate="txtTransactDate" runat="server"
                    ...
                    <asp:View runat="server" ID="View2">
                        <div style="width: 100%; height: auto">
                            ...
                            <table width="100%">
                                <tr style="width: 100%;">
                                    <td colspan="3" align="center">
                                        <asp:Label ID="lblPatientReceipt" runat="server" Text="Refund Payment Voucher" Font-Names="Verdana"
                                            Font-Size="16px" Font-Bold="True" ForeColor="#3B3535"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:GridView ID="dgvCustTransaction" runat="server" CellPadding="4" ForeColor="#333333"
                                ...
                                AllowPaging="true" PageSize="20" AutoGenerateColumns="false" OnDataBound="dgvCustTransact_DataBound"
                                Style="font-family: System" OnSelectedIndexChanged="dgvCustTransaction_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Amount" HeaderText="Refunded Amount" ReadOnly="True" SortExpression="Amount" />
