<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="AnaesthetistMaster.aspx.cs" Inherits="MainProjectHos.AnaesthetistMaster" %>
    ...
    <div style="width: 99%">
        ...
        <asp:Panel ID="pnlAddNew" runat="server">
            <table width="100%">
                <tr>
                    <td align="center">
                        <asp:Label ID="Label1" runat="server" Text="Visiting/Anaesthetist Master" Font-Names="Verdana"
                            ...
                            <td style="width: 100%" colspan="3">
                                <asp:Panel ID="pnl" runat="server" Width="100%">
                                    ...
                                    <asp:GridView ID="dgvReligion" runat="server" CellPadding="4" ForeColor="#333333"
                                        BorderColor="Green" BorderStyle="Solid" BorderWidth="1px" DataKeyNames="AnaesthetistCode"
                                            ...
                                            <asp:TemplateField HeaderText="Sr No" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkReligionCode" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>"
                                                        CommandName="EditReligion" ForeColor="Blue" Font-Underline="false" Text='<%#Eval("AnaesthetistCode") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="CategoryName" HeaderText="Doctor Category" ReadOnly="True"
                                                SortExpression="CategoryName" />
                                            <asp:BoundField DataField="AnaesthetistName" HeaderText="Visiting/AnaesthetistName"
                                                ReadOnly="True" SortExpression="AnaesthetistName" />
                                            <asp:BoundField DataField="TypeOfAnaesthesia" HeaderText="TypeOfAnaesthesia" ReadOnly="True"
                                                SortExpression="TypeOfAnaesthesia" />
                                            <asp:BoundField DataField="ConsultCharges" HeaderText="Consult Charges" ReadOnly="True"
                                                SortExpression="ConsultCharges" />
                                        </Columns>
                                    </asp:GridView>
                                </asp:Panel>
                            </td>
        ...
        <tr>
            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Panel ID="Panel2" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    height: 290px;" BorderColor="Green" BorderStyle="Solid" BorderWidth="1px">
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="lblHeading" runat="server" Text="Visiting/Anaesthetist Master" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right" style="width: 45%;">
                                                <asp:Label ID="lblReligionCode" runat="server" Text="Sr No :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtReligionCode" runat="server" MaxLength="50" ReadOnly="true" Font-Names="Verdana"
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblReligionName" runat="server" Text="Visiting/Anaesthetist Name :"
                                                    Font-Names="Verdana" Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtReligionDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="rfvReligionDesc"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtReligionDesc" Font-Size="13"
                                                        ValidationGroup="Save">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="lblTypeOfAnaesthetist" runat="server" Text=" Type Of Anaesthesia :"
                                                    Font-Names="Verdana" Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtTypeOfAnaesthetist" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td align="right">
                                                <asp:Label ID="Label6" runat="server" Text="Consulting Charges :"
                                                    Font-Names="Verdana" Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                ...
                <asp:Panel ID="pnlEditGrid" runat="server" Width="500px" Style="text-align: center;
                    background-color: #E0F0E8; height: 300px; display: none;">
                    <table width="100%" style="border-color: Green; border-style: solid; border-width: 2px"
                        cellpadding="0">
                        <tr>
                            <td>
                                <asp:Panel ID="Panel3" runat="server" Width="99.7%" Style="text-align: center; background-color: #E0F0E8;
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td align="center" colspan="2">
                                                <asp:Label ID="Label2" runat="server" Text="Visiting/Anaesthetist Master" Font-Names="Verdana"
                                                    Font-Size="15px" Font-Bold="true" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label3" runat="server" Text="Sr No :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left" colspan="5">
                                                <asp:TextBox ID="txtEditReligionCode" runat="server" MaxLength="50" ReadOnly="true"
                                                    Font-Names="Verdana" Font-Size="11px" Width="80px" Font-Bold="true"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label7" Text="Category Name : " runat="server" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535" />
                                            </td>
                                            <td align="left">
                                                <asp:DropDownList ID="ddlEditCategoryName" runat="server" Width="150px" Font-Size="11px"
                                                    Font-Names="Verdana">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" ControlToValidate="ddlEditCategoryName"
                                                    Font-Size="13" ValidationGroup="Save" ErrorMessage="*" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label4" runat="server" Text="Visiting/Anaesthetist Name :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditReligionDesc" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                        runat="server" ForeColor="Red" ControlToValidate="txtEditReligionDesc" Font-Size="13"
                                                        ValidationGroup="Edit">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label5" runat="server" Text="Type Of Anaesthesia :" Font-Names="Verdana"
                                                    Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditTypeOfAnaesthetist" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="120px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                <asp:Label ID="Label8" runat="server" Text="Consulting Charges :"
                                                    Font-Names="Verdana" Font-Size="11px" ForeColor="#3b3535"></asp:Label>
                                            </td>
                                            <td align="left">
                                                <asp:TextBox ID="txtEditCharges" runat="server" MaxLength="50" Font-Names="Verdana"
                                                    Font-Size="11px" Width="170px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
