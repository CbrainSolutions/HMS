<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmClaimApproval.aspx.cs" Inherits="MainProjectHos.InsuranceClaim.frmClaimApproval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function CheckList() {
            ...
            var copay = document.getElementById("<%=txtCoPayment.ClientID %>").value;
            var badDebts = document.getElementById("<%=txtBadDebts.ClientID %>").value;
            ...
            if ((approv == null || approv == "") && (tds == null || tds == "")) {
                ...
                document.getElementById("<%=txtRecAmount.ClientID %>").value = parseFloat(approv) + parseFloat(copay);
            }
            else if (approv != null && tds != null) {
                //var TdsAmt = approv * tds / 100;
                var copay=document.getElementById("<%=txtCoPayment.ClientID %>").value;
                document.getElementById("<%=txtRecAmount.ClientID %>").value = parseFloat(approv) + parseFloat(copay)  - parseFloat(tds);
            }
        }
    </script>
</asp:Content>
                                                    ...
                                                    <asp:Panel ID="pnl" ScrollBars="Both" runat="server" Width="1020px" Style="border-color: Green;
                                                        ...
                                                        <asp:GridView ID="dgvClaim" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Bill Settlement" ItemStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="ImageBillSettlement" runat="server" ImageUrl="~/images/edit.jpg"
                                                                            Height="24px" Width="24px" OnClick="BtnBillSettlement_Click" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                        ...
                                        <table width="100%" style="border-color: Green; border-style: solid; border-width: 2px"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 50%;" align="left">
                                                                    <asp:TextBox ID="txtApprovedate" runat="server" Font-Names="Verdana" Font-Size="11px"
                                                                        Width="150px" MaxLength="10"></asp:TextBox>
                                                                    <asp:Calendar ID="CalDate" runat="server" TargetControlID="txtApprovedate"
                                                                        Format="MM/dd/yyyy">
                                                                    </asp:Calendar>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 50%;" align="left">
                                                                    <asp:RegularExpressionValidator ID="revTxtFirstName" ValidationExpression="^([0]\d|[1][0-2])\/([0-2]\d|[3][0-1])\/([2][01]|[1][6-9])\d{2}(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$"
                                                                        ...
                                                                        Font-Size="11px" ForeColor="Red" ControlToValidate="txtApprovedate" runat="server"
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:Button ID="BtnUpdate" runat="server" Text="Settlement" Font-Names="Verdana" Font-Size="12px"
                                                        ValidationGroup="Save" BackColor="#3b3535" ForeColor="White" Width="80px" Style="border: 1px solid black"
