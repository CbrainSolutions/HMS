<%@ Page Title="" Language="C#" MasterPageFile="~/mstAdmin.Master" AutoEventWireup="true" CodeBehind="frmInsuranceClaim.aspx.cs" Inherits="MainProjectHos.InsuranceClaim.frmInsuranceClaim" %>
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="View1" runat="server">
                        <table width="100%">
                            <tr>
                                <td align="center">
                                    <asp:Label ID="Label1" runat="server" Text="Insurance Claim" Font-Names="Verdana"
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td style="width: 100%" colspan="3">
                                                    <asp:Panel ID="pnl" runat="server" Width="1020px" ScrollBars="Both" Style="border-color: Green; border-style: solid;
                                                        border-width: 1px">
                                                        ...
                                                        <asp:GridView ID="dgvClaim" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                                            ...
                                                            AutoGenerateColumns="false" DataKeyNames="ClaimId" OnDataBound="dgvClaim_DataBound"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="CoPayment" HeaderText=" CoPayment" ReadOnly="True"
                                                                    ...
                                                                    <asp:BoundField DataField="BadDebts" HeaderText="Bad Debts" ReadOnly="True"
                                                                    SortExpression="BadDebts" DataFormatString="{0:0.00}"/>
                                                                    <asp:BoundField DataField="TDS" HeaderText="TDS Amt." ReadOnly="True"
                                                                    SortExpression="TDS" DataFormatString="{0:0.00}"/>
                                ...
                                <td width="100%">
                                    <asp:Panel ID="pnlGrid" runat="server" Width="1040px" Style="text-align: center;
                                        ...
                                        <table width="100%" style="border-color: Green; border-style: solid; border-width: 2px"
                                                        ...
                                                        <table width="100%">
                                                            <tr>
                                                                <td align="center" colspan="2">
                                                                    <asp:Label ID="lblHeading" runat="server" Text="Insurance Claim" Font-Names="Verdana"
                                                            ...
                                                            <tr>
                                                                <td style="width: 50%;" align="right">
                                                                    <asp:Label ID="Label3" Text="Insurance Company:" runat="server" Font-Names="Verdana"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 50%;" align="left">
                                                                    ...
                                                                    <cc:CalendarExtender ID="CalDate" runat="server" TargetControlID="txtClaimDate" Format="MM/dd/yyyy">
                                                                    </cc:CalendarExtender>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:RegularExpressionValidator ID="revTxtFirstName" ValidationExpression="^([0]\d|[1][0-2])\/([0-2]\d|[3][0-1])\/([2][01]|[1][6-9])\d{2}(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$"
                                                                        ...
                                                                        Font-Size="11px" ForeColor="Red" ControlToValidate="txtClaimDate" runat="server"
                                                    ...
                                                    <asp:Panel ID="Panel3" runat="server" Width="1020px" Style="border-color: Green;
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression="^([0]\d|[1][0-2])\/([0-2]\d|[3][0-1])\/([2][01]|[1][6-9])\d{2}(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$"
                                                                        ErrorMessage="Please Enter Only Date With MM/DD/YYYY Format" Font-Bold="False"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Width="1020px" Style="border-color: Green;
                                                        border-style: solid; border-width: 1px">
                                                        <asp:GridView ID="dgvChargeDetails" runat="server" CellPadding="4" ForeColor="#333333"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="BillDate" HeaderText="Bill Date" ReadOnly="True" SortExpression="BillDate"
                                                                    DataFormatString="{0:MM/dd/yyyy}" />
                                                                <asp:BoundField DataField="BillType" HeaderText="Bill Type" ReadOnly="True" SortExpression="BillType" />
                                                                <asp:BoundField DataField="BillAmount" HeaderText="BillAmount" ReadOnly="True" SortExpression="BillAmount"
                                                                    DataFormatString="{0:0.00}" />
                                                                <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="ImageEdit" runat="server" ImageUrl="~/images/edit.jpg" Height="24px"
